...
const Aboutme = () => {
  return (
    <div className='h-auto w-auto text-white  flex flex-col items-center justify-between gap-44'>
      <h2 className='text-5xl text-center w-[73%]'>I Collaborate with brands and agencies to create impactful results.</h2>
      <div className=' w-[85%] flex justify-start items-start gap-14 ml-[3%]'>
      ...
      <div className=' flex  w-full justify-end mb-44'>
        <h3 className='text-5xl leading-normal w-[65.4%] font-light tracking-[-2.24px] ml-[29%] mr-[5.56%]'>I take a critical approach, applying the results of my explorations to create collisions of insight, inspiration and experimentation, for you</h3>
