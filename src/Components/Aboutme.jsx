  ...
  return (
    <div className='h-auto w-full overflow-hidden text-white  flex flex-col items-center justify-between gap-44'>
      ...
      <div className=' flex  mr-[1%]  w-full justify-center mb-44'>
        ...
        <h3 className='text-2xl md:text-3xl lg:text-4xl xl:text-5xl leading-normal md:w-[65.4%] font-light md:tracking-[-2.24px] h-auto mr- md:ml-[282px] xl:ml-[290px] '>I take a critical approach, applying the results of my explorations to create collisions of insight, inspiration and experimentation, for you</h3>
        </div>
      </div>
