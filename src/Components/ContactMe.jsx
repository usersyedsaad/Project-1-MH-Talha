  ...
  return (
    <div className='text-white  pt-[256px] flex flex-col items-center justify-between gap-[64px]'>
      ...
      <div className='lets-make-etc flex flex-col self-end gap-[24px] w-[76%]' >
        ...
        <p className='text-[#01B7C3] text-[24px] leading-normal tracking-[-0.48px]'>Get in touch if you want to discuss your project , learn more about my methodologies, or just to say hello!</p>
